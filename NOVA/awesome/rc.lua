...
require("weather")			-- Weather Library
--require("lib/mpd")			-- MPD Library
--require("awesompd")			-- AWESOMPD Library
require("cal")				-- Calendar Library / Widget
...
-- WEATHER --
  ...
  weather.register(forecast, 63088)
